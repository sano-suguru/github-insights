...
4. **ドキュメント更新**（以下を必要に応じて更新）

### ドキュメント更新ガイドライン

| ドキュメント             | 更新タイミング                               |
| ------------------------ | -------------------------------------------- |
| `CHANGELOG.md`           | 機能追加・バグ修正・リファクタリング完了時   |
| `docs/ROADMAP.md`        | Phase 完了・新機能計画時（進捗サマリー更新） |
| `docs/VISION.md`         | 設計思想に関わる大きな方針変更時             |
| `docs/IMPLEMENTATION.md` | 新しい技術的パターン・アーキテクチャ変更時   |
| `README.md`              | 機能一覧・技術スタック変更時                 |
