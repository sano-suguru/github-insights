...
- [ ] **GitHub Wrapped（年末キャンペーン）**
  - 年間統計サマリー生成
  - 「今年のハイライト」表示
  - シェアしやすいOGカード

- [ ] **Twitterカード最適化**
  - summary_large_image対応
  - シェア時のプレビュー改善

---

### 📋 Phase 5: UX改善・Pro機能準備
...
### 短期（3ヶ月）
1. **Phase 4「Insight Score」実装** → バイラル要素の確立
2. **GitHub Wrapped キャンペーン** → 年末の認知拡大
3. **Twitterカード最適化** → シェアされやすさ強化

### 中期（6ヶ月）
1. **Phase 5 完了** → テーマ切り替え、ストリーク表示
